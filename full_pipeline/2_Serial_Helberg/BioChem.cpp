...
int Biochem(vector<length_t> &VectorCode, int n){
    ...
    GC_Content(Bad_Codes, Nucleotide_Codes);             //Check GC content

    Palindromes(Bad_Codes, Nucleotide_Codes);                //Look through for palindromes and inverted repeats
